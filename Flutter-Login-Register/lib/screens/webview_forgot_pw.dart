...
class WebViewForgotPW extends StatefulWidget {
  @override
  _WebViewForgotPWState createState() => _WebViewForgotPWState();
}

class _WebViewForgotPWState extends State<WebViewForgotPW> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          initialUrl: Constants.LOST_PASSWORD,
